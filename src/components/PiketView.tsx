    ...
    <section id="view-piket" className="view-section fade-in">
        <div className="glass-card p-4">
            <div className="flex justify-between items-center mb-4">
                ...
                <button type="button" onClick={fetchDataPiket} className="btn-click bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white w-8 h-8 rounded-lg text-xs font-bold shadow-sm border border-gray-200 dark:border-gray-700 flex justify-center items-center">
                        ...
                        {laporanPiket.length === 0 ? (
                          ...
                          <div key={l.id} className="bg-white dark:bg-gray-800 p-3 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
                            <div className="flex justify-between items-start mb-1">
                              ...
                              <div className="text-[9px] text-gray-500 dark:text-white/80">{l.tanggal}</div>
                            </div>
              ...
              <div id="piket-content-form" className="fade-in space-y-4">
                  ...
                  <form onSubmit={handlePiketSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        <textarea value={catatan} onChange={e => setCatatan(e.target.value)} rows={2} className="w-full px-3 py-2.5 text-sm rounded-xl input-premium resize-none text-gray-900 dark:text-white" placeholder="Deskripsikan kejadian saat piket..."></textarea>
                      </div>
                      <div>
