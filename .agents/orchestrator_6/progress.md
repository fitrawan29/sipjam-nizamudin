...
- [ ] Implement R2 (Teacher Dashboard: stats card H/TL/I/S, target ratio, attendance %, doc upload status)
- [ ] Implement R3 (Admin Dashboard: real-time status matrix & reactive verification filters)
- [ ] Implement R4 (Picket assignment & Perangkat Pembelajaran matrix card)
- [ ] Implement R5 (Broadcast announcement system & smooth UI animations/transitions)
- [ ] Review & Challenger testing
- [ ] Forensic Audit
- [ ] Final Git Commit & Push & Report to Parent
