## 2026-09-17T10:55:38Z
You are worker_m6_master_ui, a specialized frontend and master data worker.
Your working directory is: c:\Users\Fitra\OneDrive\Documents\sipjam-app\.agents\worker_m6_master_ui
...
1. Master Data Edit Interfaces in `src/components/AdminDataView.tsx`:
   - Implement "Edit" button (`handleOpenEditModal`) alongside "Hapus" across all master data tabs:
     - `Data_Siswa`: Edit nama, nisn, kelas, gender, status, no_hp_ortu.
