...
| M2 | Notifikasi Penolakan, Auto-Alpa Cutoff & Warning 3x | F5, F6, F7 | M1 (interfaces) | IN_PROGRESS |
| M3 | UI/UX, Branding & Apple Compatibility | F8, F9, F10, F11 | none | IN_PROGRESS |
